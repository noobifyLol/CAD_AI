# Import Summary 1778893913

- Knowledge rows added: 11
- Pruning rules added: 11
- CAD memory/example rows ready: 406
...
- Diagnostics log: logs/learning_diagnostics_1778893385.txt and logs/learning_diagnostics_1778893879.json
- Smoke generation log: logs/generations_20260516011105.json

## Diagnostics Summary

- Static smoke success rate: 100% (6/6)
- Missing adaptive tables: none
